let BTN_REGISRTER_USER='<button type="button" class="btn btn-primary" style="width: 100%;" onclick="window.location.href='+'/users/register'+'" >Registrar Nuevo Usuario</button>';
...
let BTN_PREDIOS='<button type="button" class="btn btn-primary" style="width: 100%; margin-top: 10px;" onclick="window.location.href='+'/users/geoportPredios'+'">Portal de Predios</button>';
let BTN_VIAS='<button type="button" class="btn btn-primary" style="width: 100%; margin-top: 10px;" onclick="window.location.href='+'/users/geoportVias'+'">Portal de Vias</button>';
