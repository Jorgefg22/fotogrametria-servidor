        ...
        L.geoJSON(data, {
            style: function (feature) {
                ...
                if (feature.properties.estado_acumulativo == 0) {
                    ...
                    fillColor = '#fbfbfb';
                } else if (feature.properties.estado_acumulativo == 5) {
                    fillColor = '#999682';
                } else if (feature.properties.estado_acumulativo == 6) {
                    fillColor = '#6f30cf';
                } else if (feature.properties.estado_acumulativo == 7) {
                    fillColor = '#090a0a';
                } else if (feature.properties.estado_acumulativo == 8) {
                    fillColor = '#666767';
                }
